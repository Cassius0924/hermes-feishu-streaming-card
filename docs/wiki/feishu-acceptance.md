...
- Issue #158 还需在 Ubuntu 24.04 / Hermes 实际 upstream update 后走完整官方命令复测；不得手工修改 fence 或调用内部函数。以上为 V4.1.3 发布前待验收项，未实际完成自动化、候选安装与真实环境复测前不得标记通过。
