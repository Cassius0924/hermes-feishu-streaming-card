...
| 版本 | 重点 |
|---|---|
| [v4.1.2](docs/release-notes-v4.1.2.md) | 修复 Gateway 正常重启时 heartbeat 短暂 stale 被误写为持久化 restart fence 的竞态；新 matching hello 可一次恢复 ready；延续 [v4.1.1](docs/release-notes-v4.1.1.md) 的升级恢复安全边界 |
