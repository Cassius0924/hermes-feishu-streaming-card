...
| 版本 | 重点 |
|---|---|
| [v4.0.21](docs/release-notes-v4.0.21.md) | Issue #155：仅显式 `answer -> tool` 边界归档答案，避免 post-tool 最终答案被移入 timeline；锁定 Issue #147 图片/notice 组合回归，UI 与配置不变，真实飞书图片 smoke 待完成 |
