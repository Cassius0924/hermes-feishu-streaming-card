...
```bash
export FEISHU_APP_ID=cli_xxx FEISHU_APP_SECRET=xxx HFC_VERSION=v4.3.4
...
- V4.3.x: thanks to [leavrcn](https://github.com/leavrcn) (Issues #210/#211/#212/#221), [jsuper](https://github.com/jsuper) (Issue #214), [nasvip](https://github.com/nasvip) (Issue #215), [mouyong](https://github.com/mouyong) (Issue #217), [Cassius0924](https://github.com/Cassius0924) (PRs #213/#220), and [L261173157](https://github.com/L261173157) (Issue #222 / PR #223) for key evidence or proposals around the Hybrid runtime, interaction state, persistent service, upgrade recovery, approval, and callback retry; thanks to [saulgoodmanngabriel](https://github.com/saulgoodmanngabriel) and [zhangzq](https://github.com/zhangzq) for real Hermes 0.20 / Feishu WebSocket click and streaming-resume evidence in Issue #216; and thanks to [RanHuang](https://github.com/RanHuang) for PR #226, which exposed persistent-service identity, systemd `WorkingDirectory`, and tokenless-health reconciliation gaps.
